...
require_once 'validate.php';
    ...
    $sql = "
        ...
        DELETE FROM locacao WHERE vehicle_id = @vehicle_id;
    ...
    if (mysqli_multi_query($conn, $sql)) {
        echo "<script>alert('Todas as informações sobre esse veículo foram excluídas permanentemente!!'); window.location.href = 'reservlab.php?dellab';</script>";
    } else {
