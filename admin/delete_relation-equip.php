...
require 'connect.php';
    ...
    $sql = "
        ...
        DELETE FROM locacao WHERE equip_id = @equip_id;
    ...
    if (mysqli_multi_query($conn, $sql)) {
        echo "<script>alert('Todas as informações sobre esse equipamento foram excluídas permanentemente!!'); window.location.href = 'reservlab.php?dellab';</script>";
    } else {
