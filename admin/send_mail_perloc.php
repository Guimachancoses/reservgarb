<?php
    ...
    function sendMailPerLoc ($email, $nome, $assunto, $dtname, $dtemail, $message, $dadosLocacao){
                                                                              ...
                                                                              >
                                                                                <a
                                                                                  ...
                                                                                  >ESSA MENSAGEM É AUTOMÁTICA, FAVOR NÃO RESPONDER.
                                                                                    ...
                                                                                    <p>
                                                                                    <strong style="color: red;">Reserva por período solicitada.</strong>
                                                                                    </p><br>
                                                                                    ...
                                                                                    <strong>Aguardando sua aprovação</strong></h5>
                                                                                </a>
                                                                              </td>
                                                                            </tr>
