                        ...
                        if (mysqli_num_rows($q_msg) > 0) {
                            while ($f_msg = $q_msg->fetch_array()) {
                                ...
                                <?php if ($pendente === "Solicitações pendentes!") { ?>
                                    <li>
                                        <?php $penlab = 'penlab'; ?>
                                        <a style="display:block;align-items:left;justify-content:left;box-shadow: 0px 0px 5px black;" href="reservlab.php?<?php echo $penlab ?>" class="text-primary"><?php echo $pendente ?></a>
                                    </li>
                                <?php } elseif ($pendente === "Reserva Por Período Pendente!") { ?>
                                    <li>
                                        <?php $perpen = 'perpen'; ?>
                                        <a style="display:block;align-items:left;justify-content:left;box-shadow: 0px 0px 5px black;" href="reservlab.php?<?php echo $perpen ?>" class="text-primary"><?php echo $pendente ?></a>
                                    </li>
                                <?php } ?>
                                <?php
                            }
