                    ...
                    <div  class = "col-md-10" style="min-height:850px">	
                        <form method = "POST" action = "edit_query_account_users.php?users_id=<?php echo $fetch['users_id']?>">
                            ...
                            <div class="card-foot">
                                ...
                                <input type = "text" class = "form-control" id="usuario" value = "<?php echo substr($fetch['username'], 0, 4) . "/" . substr($fetch['username'], 4, 2) . "-" . substr($fetch['username'], 6, 1); ?>" name = "username" />
                            </div>
                            <div class="card-foot">
                                <label><strong> Função:</strong></label>
                                <select class = "form-control" required = required name = "funcao">
