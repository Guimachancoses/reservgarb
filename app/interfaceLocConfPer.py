...
from Model.querieLocationConfPer import Queries
import json
import sys
...
if __name__ == '__main__':
    try:
        ...
        if len(sys.argv) > 1:
            ...
            lista_contatos = Queries.consul_loc_conf_periodo(IDlocation_value)
            # Verifica se a lista de contatos não está vazia
            if lista_contatos:  
                # Mensagem a ser enviada
                mensagem = "Olá esta é uma mensagem automática do serviço de reserva da Garbuio, sua solicitação foi aprovada.\n Acesse em seu navegador o link: http://agenda.garbuio.int, caso queira acompanhar."
