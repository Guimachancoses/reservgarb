...
<?php
	...
	if(ISSET($_POST['change_password'])){
		...
		$queryrl = $conn->prepare("SELECT u.password FROM `users` as u	WHERE u.funcao = 'Coordenador' && u.users_id = ?") or die(mysqli_error($conn));
