		...
		<div class="row">
			<div class="col-lg-10 col-md-9">
				<div class="card" style="min-height:750px">
					...
					<h4 class="card-title"><strong class="text-primary"> Pedidos por Período Reservados</strong></h4>
                    ...
                    <thead class="text-primary" style="cursor:pointer">
                        ...
                        <tbody>
                            ...
                            <tr <?php if($fetch['assunto'] == 'Reserva atrasada!'){ echo 'style="background-color: #f2bdcd;cursor:pointer;"'; } else {echo 'style="cursor:pointer;"';} ?> onclick="window.location='<?php echo $editLink ?>'">
                                ...
                                <td><a class = "btn btn-warning" href = "checkout_query_per.php?lc_period_id=<?php echo $fetch['lc_period_id']?>" onclick = "confirmationCheckin(); return false;"><abbr style="display:flex;text-decoration:none" title="Liberar"><i class = "material-icons">task</i></abbr></a></td>
                            </tr>
                            <?php
                                }	
                            ?>
