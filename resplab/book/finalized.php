				...
				<div class="card" style="min-height:750px">
                    ...
                    <table class="table table-hover" id="myTable">
                        ...
                        <?php
                            ...
                            $totalResults = $conn->query("SELECT COUNT(*) as total FROM locacao WHERE users_id != $session_id AND mensagens_id = 4")->fetch_assoc()['total']; // Total de resultados no banco de dados
