        ...
        <div class="col-lg-9">
            ...
            <div class="card-foot" style="padding: 10px; display: flex; justify-content: flex-start;">
                ...
                <div class="card-header card-header-text">
                    <h4 class="card-title"><strong class="text-primary">Salas</strong></h4>
                ...
                <div class="card-content table-responsive" style="padding:2">
                        <div class = "panel panel-default" >
                            <?php
                                ...
                                $query = $conn->query("SELECT * FROM `laboratorios` ORDER BY room_id Desc") or die(mysqli_error($conn));
                            ...
                            <div class="card">
                                <div class = "well" style = "height:280px; width:100%;">
                                    ...
                                    <div style = "float:left; margin-top:120px;margin-bottom:10px">
                                        <h3 class="category"><?php echo '<strong class="text-primary">Nome: </strong>'.$fetch['room_type']?></h3>
                                        <h3 class="category"><?php echo '<strong class="text-primary">Modelo: </strong>'.$fetch['room_no']?></h3>
                                        <h3 class="category"><?php echo '<strong class="text-primary">Capacidade: </strong>'.$fetch['capacity']?></h3>
                                        </br>
                                        <a class="btn btn-info" href="reservlab.php?rsalender" style="display: flex; align-items: center; text-decoration: none;justify-content:center;">
