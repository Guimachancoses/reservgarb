<?php
    ...
    function sendMail ($email, $nome, $assunto, $dtname, $dtemail, $message, $codigo){
        ...
        try {
            ...
            // // Obter o caminho absoluto da imagem de fundo "background_1.jpg"
            // $imagePath4 = BASE_DIR . '/img/mailpic.jpg';

            // // Adicionar a imagem ao e-mail com o identificador "cid:background"
            // $mail->AddEmbeddedImage($imagePath4, 'mailpic', 'mailpic.jpg');
                                                                              ...
                                                                              >
                                                                                <a
                                                                                  ...
                                                                                  >ESSA MENSAGEM É AUTOMÁTICA, FAVOR NÃO RESPONDER.
                                                                                    ...
                                                                                    <strong>Administrador: '.$nome.'.</strong><br>
                                                                                    <strong>Email: '.$email.'</strong><br><br>

                                                                                    
                                                                                    <strong style="color: red;">Você recebeu esse e-mail para recuperar seu acesso ao portal de
                                                                                        reservas da Garbuio.</strong>
                                                                                    <br>
                                                                                    <strong style="color: red;">Caso não tenha sido você que tenha solicitado, desconsidere esse
                                                                                        email.</strong>
                                                                                    <br><br>
                                                                                    <strong>Copie o código informado e clique no botão abaixo</strong>
                                                                                    <ul>
                                                                                        <li>Código: '.$codigo.'</li>
                                                                                    </ul>

                                                                                    <strong>Confirme abaixo para mudar sua senha.</strong></h5>
                                                                                </a>
                                                                              </td>
                                                                            </tr>
                                                                                    ...
                                                                                    <tr>                                                                                       
                                                                                      ...
                                                                                      >                                                                                                                                                              
                                                                                        <a
                                                                                          ...
                                                                                          href="http://agenda.garbuio.int/reservgarb/forgot/validateuser.php"
                                                                                          _label="Confirmar"
                                                                                          target="_blank"
                                                                                          style="
                                                                                            color:#444444;
