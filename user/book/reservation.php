			...
			<div class="col-lg-12 col-md-9">
				<div class="card" style="min-height:725px">
					...
					<h4 class="card-title"><strong class="text-primary"> Reservas Pendentes</strong></h4>
						<p class="category">Acompanhar pedidos de reservas pendentes:</p>
					</div>
                        ...
                        <tbody>
                            <?php
                                $query = $conn->query("SELECT
                                                        ...
                                                        WHERE lc.status_id = 1 && ms.mensagens_id = 2 && lc.users_id = '$_SESSION[users_id]' ") or die(mysqli_error());
                            ...
                            <tr>
                                ...
                                <td><center><a style="padding:1px" class = "btn btn-danger" onclick = "confirmationDelete(); return false;" href = "delete_pending.php?locacao_id=<?php echo $fetch['locacao_id'].'&room_id='.$fetch['room_id']?>"><abbr title="Deletar"><i class = "material-icons">delete</i></abbr></a></center></td>
                            </tr>
                            <?php
                                }	
                            ?>
