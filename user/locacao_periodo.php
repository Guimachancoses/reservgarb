                ...
                if ($timeTo > $timeFrom) {
                    ...
                    if ($verife == 0){
                        ...
                        while ($stmt->fetch()) {
                            ...
                            // Constrói um array associativo com a chave 'IDlocation' e o valor $lc_period_id
                            $data = array('"IDlocation"' => $lc_period_id);

                            // Codifica a lista de contatos como JSON para ser passada para o script Python
                            $IDlocation_json = json_encode($data);

                            // Executa o script Python com o id de locação como argumentos de linha de comando
                            exec("start /B C:/xampp/htdocs/reservgarb/app/interfaceLocPenPer.py \"$IDlocation_json\" > teste &" );
                        }
