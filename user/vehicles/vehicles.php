                    ...
                    <div class="card-content table-responsive" style="padding:2">
                        <div class = "panel panel-default" >
                            <?php
                                ...
                                $editLink = "reservlab.php?vehicle_id=".$fetch['vehicle_id']."&rscalender";
                            ?>
                            <div class="card">
                                <div class = "well" style = "height:280px; width:100%;">
                                    ...
                                    <div style = "float:left; margin-top:120px;margin-bottom:10px">
                                        ...
                                        <a class="btn btn-info" href='<?php echo $editLink ?>' style="display: flex; align-items: center; text-decoration: none;justify-content:center;">
